...
/**
 * @class EventTarget
 * @classdesc The EventTarget interface.
 ...
 */
EventTargetPrototype.off = function off(events, selector, handler) {
 ...
 */
EventTargetPrototype.on = function on(events, selector, data, handler, /*INTERNAL*/ one) {
 ...
 */
EventTargetPrototype.one = function(events, selector, data, handler) {
 ...
 *     triggered event handler(s).
 */
EventTargetPrototype.trigger = function(event, extraParameters) {
 ...
 */
EventTargetPrototype.triggerHandler = function(event, extraParameters) {
